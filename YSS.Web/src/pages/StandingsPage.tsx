                ...
                <table className="standings-table">
                  <thead>
                    <tr>
                      ...
                      <th className="col-sors" title="Strength of Remaining Schedule: average points per match (PPM) of upcoming opponents within this region. Higher = tougher remaining schedule.">SORS</th>
